...
export const addEventConversation = async (conversation, ctx) => {
    let eventName = 'Название мероприятия';
    ...
    await conversation.external(() => addEvent(eventName, eventDate, eventLink, eventNote));
